...
DELIMITER //
	CREATE FUNCTION add_float(value1 FLOAT, value2 FLOAT) RETURN FLOAT
BEGIN
...
# 方式一
DELIMITER //
CREATE FUNCTION text_if_case(score DOUBLE) RETURNS CHAR
BEGIN
...
BEGIN
	...
	DO
		INSERT INT admin(user_name, user_pwd) 
		VALUE(CONCAT('Rose-', i), ROUND(RAND() * 1000000));
		SET i = i + 1;
	END WHILE;
...
![image-20230307150807781](D:\typora图片\image-20230307150807781.png)
