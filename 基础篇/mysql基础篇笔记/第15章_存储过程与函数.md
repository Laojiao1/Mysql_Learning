...
DELIMITER //
CREATE PROCEDURE insert_user(IN username VARCHAR(15), IN pass_word VARCHAR(25))
BEGIN
	INSERT INTO admin(user_name, pwd)
	VALUE (username, pass_word);
END //
...
DELIMITER //
CREATE PROCEDURE get_phone(IN ID INT, OUT name VARCHER(15), OUT phone VARCHAR(15))
BEGIN
...
DELIMITER //
CREATE PROCEDURE format_date(IN date DATETIME, OUT strdate VARCHAR(50))
BEGIN
...
BEGIN
	RETURN( SELECT AVG(salary)
            ...
            ON e.department_id = d.depertment_id
            WHERE d.depertment_id = dept_name);
END &
...
DELIMITER &
CREATE FUNCTION add_float(value1 float1, value2 float2) 
RETURNS FLOAT
BEGIN
