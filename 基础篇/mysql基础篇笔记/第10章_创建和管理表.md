...
CREATE DATABASE IS NOT EXISTS test01_office CHARACTER SET 'utf8'
USE test01_office;
...
ALTER TBALE dept02 ADD test_column CVARCHAR(10);
DESC dept02;
...
CREATE DATABASE IS NOT EXISTS test02_market CHARACTER SET 'utf8';
...
# ALTER TABLE customers REANEM TO customers_info;
...
ALTER TABLE employees MODIFY VARCHAR(20) AFTER `code`;
